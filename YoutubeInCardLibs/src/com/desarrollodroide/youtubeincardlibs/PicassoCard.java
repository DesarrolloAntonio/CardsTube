...
public class PicassoCard extends Card {
    ...
    protected String mURLThumbnail;
    protected int count;

    public PicassoCard(Context context, String urlThumbnail) {
        this(context, R.layout.carddemo_extra_picasso_inner_content, urlThumbnail);
    }

    public PicassoCard(Context context, int innerLayout, String urlThumbnail) {
    ...
    private void init() {
        ...
        //Add thumbnail
        PicassoCardThumbnail cardThumbnail = new PicassoCardThumbnail(mContext, this.mURLThumbnail);
...
//            secondaryTitle.setText(mSecondaryTitle);
    ...
    class PicassoCardThumbnail extends CardThumbnail {
        ...
        public PicassoCardThumbnail(Context context, String mURLThumbnail) {
            super(context);
        }
        ...
        public void setupInnerViewElements(ViewGroup parent, View viewImage) {
            ...
            //It is just an example !
                ...
                Picasso.with(getContext())
                        .load(PicassoCard.this.mURLThumbnail)
